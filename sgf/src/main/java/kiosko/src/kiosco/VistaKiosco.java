...
public class VistaKiosco extends JFrame implements InterfazDelCliente {
    ...
    public VistaKiosco() {
        ...
        for (String texto : botonesTeclado) {
            ...
            btn.addActionListener(e -> {
                ...
                validarDNI(); // Validar cada vez que se modifica el texto
            });
        ...
        btnSolicitar.setEnabled(false); // Deshabilitado inicialmente
    ...
    public Configuracion getConfiguracion() {
        ...
        int option = JOptionPane.showConfirmDialog(null, message, "Configuración del Kiosco",
                JOptionPane.OK_CANCEL_OPTION);
        if (option != JOptionPane.OK_OPTION) {
            return null;
        }

        Configuracion config = ConfiguracionFactory.crearConfiguracion(
                txtIpPrimario.getText().trim(),
                txtIpRespaldo.getText().trim(),
    ...
    public void setActionListener(ActionListener al) {
        btnSolicitar.setActionCommand(InterfazDelCliente.SOLICITAR);
        btnSolicitar.addActionListener(al);
    }
