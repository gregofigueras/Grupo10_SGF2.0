...
public class PanelOperador extends JFrame {
    ...
    public PanelOperador() {
        ...
        // 2. TÁCTICA DE RECUPERACIÓN: Notificar al servidor al cerrar para liberar el
        // puesto
    ...
    private boolean configurarPuesto() {
        while (true) {
            ...
            try {
                ...
                try (Socket socket = conectarConReintento(this.puertoServidor);
                    ...
                    if ("DUPLICADO".equals(respuesta)) {
                        JOptionPane.showMessageDialog(null,
                                "Error: El Puesto #" + this.idPuesto
                                        + " ya está conectado al Servidor. Elija otro número.",
                                "Puesto Ocupado", JOptionPane.ERROR_MESSAGE);
                ...
                JOptionPane.showMessageDialog(null,
                        "Error de red: No se pudo conectar con el servidor. Verifique IP y Puerto.",
